            ...
            >
              ...
              <div className="flex gap-2">
                {!r.completed && !isClosed && (
                  <>
                    <button type="button" onClick={() => startEditReminder(r)} className="text-xs text-brand-600 hover:underline">
                      Edit
                    </button>
                    <button type="button" onClick={() => completeReminder(r.id)} className="text-xs text-brand-600 hover:underline">
                      Done
                    </button>
                    <button type="button" onClick={() => deleteReminder(r.id)} className="text-xs text-red-600 hover:underline">
                      Delete
                    </button>
                  </>
                )}
                {r.completed && !isClosed && (
                  <button type="button" onClick={() => reopenReminder(r.id)} className="text-xs text-brand-600 hover:underline">
                    Undo
                  </button>
                )}
              </div>
