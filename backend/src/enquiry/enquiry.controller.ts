...
export class EnquiryController {
  ...
  @Get('stats')
  getStats(@Query() query: EnquiryStatsQueryDto) {
    return this.enquiryService.getStats(query);
  }
  ...
  updateReminder(
    ...
    return this.enquiryService.updateReminder(id, reminderId, dto);
  }

  @Patch(':id/reminders/:reminderId/reopen')
  reopenReminder(
    @Param('id') id: string,
    @Param('reminderId') reminderId: string,
  ) {
    return this.enquiryService.reopenReminder(id, reminderId);
  }
  ...
  deleteReminder(
    ...
    return this.enquiryService.deleteReminder(id, reminderId);
  }
}
